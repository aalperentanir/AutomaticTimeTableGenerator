...
export class RoomService {
  ...
  public searchRooms(keyword: string, page: number, size: number): Observable<PageRoom> {
    return this.http.get<PageRoom>(environment.backendHost + "/classrooms/search?keyword=" + keyword + "&page=" + page + "&size=" + size);
  }

  public saveRoom(salle: Room): Observable<Room> {
